mongoose-plugins-timestamp
===========================

npm install mongoose-plugins-timestamp

A simple timestamp plugin for mongoose.

pluginTimestamp = require "mongoose-plugins-timestamp"
YourSchema.plugin pluginTimestamp.timestamps
...
## Contributing to mongoose-plugins-timestamp
